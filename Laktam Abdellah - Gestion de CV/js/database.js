...
const database = [
    ...
    },
    {
        profile: {
            ...
            phone: "+212 672045009",
            email: "samira.abida2018@gmail.com",
            address: "Meknès, Maroc",
            professionalSummary: `Ingénieure en informatique avec une bonne expérience sur les architectures logicielles et les nouvelles technologies
             informatique, en l'occurence Jakarta EE, Spring Boot, React et Angular. Expérimenté dans la gestion de projets agiles, planification,
              exécution et coordination des tâches avec des équipes multifonctionnelles. Disposant des compétences requises en 
            communication et en résolution de problèmes avec un esprit ouvert en collaboration efficace avec les parties prenantes et les membres 
            de l'équipe.
            `,
            links: ["https://www.linkedin.com/in/samira-abida-6aa2a11bb/", "", ""]
        },
        education: [
            {
                diploma: "Master MQL",
            ...
            {
                diploma: "Licence Arssi",
                organisation: "FS - Université Abdelmalek Essaâdi  - Tetouan",
                year: 2022
            },
            {
            ...
            {
                diploma: "Baccalauréat Série Science physique et chimique",
                organisation: "Lycée - Omar Ibn Al Khattab - Meknes",
                year: 2019
            }
        ],
        technologySkills: [
        ...
        experiences: [
            {
                type: "Stage",
                organisation: "Itec Zone - Meknes",
                title: "Réalisation d’une Plateforme d'Apprentissage de la Langue allemande pour les individus qui cherchent à évaluer et à certifier les compétences linguistiques de manière pratique et efficace.",
                technologies: ["HTML", "CSS", "PHP", "Laravel", "PHP", "JavaScript"],
                year: 2023,
                duration: "1 mois"
            },
            {
                type: "Stage",
                organisation: "Medyouin - Meknes",
                title: "Réalisation d’une application web dédiée à la gestion des cabinets médicaux convenir à tout type de médecins généralistes et spécialistes: La gestion des cabinets, des patients, des rendez-vous, des consultations, des ordonnances, des personnels.",
                technologies: ["HTML", "CSS", "PHP", "Laravel", "PHP", "JavaScript"],
                year: 2023,
                duration: "2 mois"
            },
            {
                type: "Stage",
                organisation: "Sama Design - Meknes",
                title: "Réalisation d’une application qui facilite et génère toutes les tâches nécessaires pour assurer la gestion administrative des activités. Parties administrateur, Partie employé, Partie utilisateur.",
                technologies: ["HTML", "CSS", "PHP", "Laravel", "PHP", "JavaScript"],
                year: 2022,
                duration: "1 mois"
            },
            {
                type: "Stage",
                organisation: "Préfecture - Meknes",
                title: "Mettre en place un serveur de messagerie Exchange de type local pour un échange collaboratif entre les salariés de la préfecture.",
                technologies: [""],
                year: 2022,
                duration: "2 mois"
            }, {
                type: "Stage",
                organisation: "la cour d’appel - Meknes",
                title: "Réalisation d’une application web qui permet de faciliter la recherche, l'ajout, la modification et la suppression des dossiers, des juges, des utilisateurs, des sections et des types de dossiers.",
            ...
            },
            {
                ...
                organisation: "ESTM",
                title: "Réalisation d’un site web dédié à l’achat et la vente à distance, connu sous le nom d'e-commerce. Parties clients produit et achat, Partie administrateur, Partie livreur.",
                technologies: ["HTML", "CSS", "PHP", "JavaScript"],
                year: 2021,
                duration: "2 mois"
            }
    ...
    },
    {
        profile: {
            ...
            phone: "+212 650103135",
            email: "heyynazih@gmail.com",
            address: "Fes",
            professionalSummary: `Actuellement étudiant en Master Qualité du Logiciel (MQL) et titulaire d'une Licence Professionnelle en Développement des Systèmes d'Information et de Communication,
            j'ai acquis une expertise solide en développement et conception de systèmes d'information. 
            Je maîtrise les différentes étapes techniques du processus de développement,
             ce qui me permet également de comprendre les besoins des utilisateurs d'un point de vue technique.`,
            links: ["https://www.linkedin.com/in/nazihamri",
                "https://github.com/nazih-amri"]
        },
        education: [
            {
                diploma: "Master MQL",
            ...
            {
                diploma: "Licence Professionnelle : Développement des Systems d'information et de communication",
                organisation: "ESTM - Université Moulay Ismaïl - Meknès",
                year: '2022 - 2023'
            },
            {
        ...
        experiences: [
            {
                type: "Stage",
                organisation: "GYGES - Casablanca",
                title: "Réalisation d'une Application Web de Gestion des Inscriptions pour une École Supérieure",
            ...
            {
                type: "Stage",
                organisation: "Faculté de Médecine et de Pharmacie - Fès",
                title: "Réalisation d’une Application Web de Gestion des Médecins Résidents en Faculté de Médecine, Fès",
                technologies: ["Laravel", "React", "Node.js"],
                year: 2022,
                duration: "2 mois"
            },
            {
                type: "Projet",
                organisation: "ESTF",
                title: "Réalisation d’une Application Web de Gestion du Concours d’Accès au Résidanat en Médecine ou en Pharmacie",
                technologies: ["Laravel", "React", "Node.js"],
                year: 2022,
                duration: "4 mois"
            },
            {
                ...
                title: "Réalisation d’une Application Web de Gestion des Commandes",
        ...
        interests: ["Fitness", "Lecture de livres", "Voyage",]
    },
    {
        profile: {
            photo: "resources/Bibi_Hiba.jpg",
            firstName: "Hiba",
            lastName: "Bibi",
            birthday: {
                day: 20,
            ...
            phone: "+212690479184",
            email: "Bibihiba2002@gmail.com",
            address: "Fès",
            professionalSummary: `Étudiante en Master Qualité du Logiciel (MQL) à la faculté des sciences Dhar El Mahraz, 
            spécialisée en développement web et passionnée par les technologies numériques et l'innovation.
            Je possède une solide base en programmation et une volonté constante d'apprendre.
            Mon objectif est de perfectionner mes compétences et de contribuer à des projets innovants au sein d'équipes dynamiques.`,
            links: ["https://www.linkedin.com/in/hiba-bibi"]
        },
        education: [
            {
                diploma: "Master MQL",
            ...
            {
                diploma: "Deug en Science Mathématique et Informatique (SMI)",
                organisation: "FSDM - Université Sidi Mohammed ben Abdellah - Fès",
                year: 2022
            },
            {
                diploma: "Baccalauréat Science Mathématique B",
                organisation: "Lycée Abdelkrim Raiss - Fès",
                year: 2020
            }
        ],
        technologySkills: [
        ...
        experiences: [
            ...
            },
            {
                ...
                organisation: "FSDM",
                title: "Générateur de diagrammes UML",
                technologies: ["Java", "Swing", "DOM", "SAX"],
                year: 2023,
                duration: "1 mois"
            },
            {
                type: "Projet de fin d'études",
                organisation: "FSDM",
                title: "Réalisation d'une application de Quiz",
                technologies: ["HTML", "CSS", "JavaScript", "Jakarta Enterprise Edition (JEE)", "AJAX", "SQL"],
                year: 2023,
                duration: "3 mois"
            }
        ],
    ...
    },
    {
        profile: {
            ...
            phone: "+212 77 81 89 281",
            email: "hanane.allou01@gmail.com",
            address: "Fes",
            professionalSummary: `Ingénieur en informatique avec une bonne expérience 
                ...
                et les membres de l'équipe.
            `,
            links: ["https://ma.linkedin.com/in/hanane-allou-35a509195", "", ""]
        },
        education: [
            {
                diploma: "Master MQL",
            ...
            {
                diploma: "LICENCE EN SCIENCES MATHEMATIQUES ET INFORMATIQUES",
                organisation: "FSDM - Université Sidi Mohammed ben Abdellah - Fès",
                year: "2022-2023",
            },
            {
                diploma: "ANNEE EQUIVALENCE",
                organisation: "FSDM - Université Sidi Mohammed ben Abdellah - Fès",
                year: "2021-2022"
            },
            {
                diploma: "DUT EN INFORMATIQUE DECISIONNELLE",
                organisation: "Ecole superieure de technologie - Université Sidiv Mohammed ben Abdellah - Fès",
                year: "2019-2021"
            }
        ],
        technologySkills: [
            ...
            {
                skill: "Plateforme &amp; Frameworks .NET",
                details: "ASPX, CSHTML (Razor), Web Parts, Remoting, WCF, ADO.NET, Entity Framework, SharePoint, BizTalk."
            },
            {
                skill: "Ingénierie du Web",
                details: "HTML, CSS, JavaScript, Node.js, React, Angular"
        ...
        experiences: [
            {
                type: "Stage",
                organization: "Maroc Modis Maroc (fes)",
                title: "Participation un projet d'analyse de données, en utilisant des outils d'informatiqu décisionnelle.",
                technologies: "Talend, MySql, Power BI",
                year: "2021",
                duration: "Deux mois"
            },
            {
                type: "Projet",
                details: "Ce projet consistait à concevoir et développer une application mobile ainsi qu'une application web BackOffice pour la vente en ligne de produits artisanaux",
                technologies: "JEE, Android Studio,HTML, CSS, JavaScript,Ajax",
                year: "2023",
            }
        ],
    ...
    },
    {
        ...
        experiences: [
            ...
            },
            {
                ...
                organisation: "Faculté des sciences Dhar El Mehraz, Fès",
                title: "Réalisation d'une application de Gestion de CVs",
                descreption: "Développement d'une application web de gestion de CV, permettant la création, la personnalisation et la géstion de plusieurs CV en ligne.",
                technologies: ["HTML", "CSS", "JavaScript"],
                year: 2023,
                duration: "3 semaines"
            }
    ...
    },
    {
        profile: {
            ...
            phone: "+212697135606",
            email: "hibamousmi1@gmail.com",
            address: "Fès",
            professionalSummary: ` Ingénieur en informatique dotée d'une bonne expérience
            en terme des architectures logicielles et des nouvelles technologies informatique,
            en l'occurence Jakarta EE, Spring Boot, React et Angular. Disposant des compétences requises en
            communication et en résolution de problèmes avec un esprit ouvert en collaboration efficace avec les
            parties prenantes et les membres de l'équipe. Je cherche à relever de nouveaux défis.
            `,
            links: ["", "", ""]
        },
        education: [
            {
                diploma: "1 ère année Master Qualité du Logiciel - MQL",
                organisation: "FSDM - Université Sidi Mohammed ben Abdellah - Fès",
                year: 2024
            },
            {
                diploma: "Licence Professionnelle Informatique, Web et Applications Mobiles",
                organisation: "FS-Rabat",
                year: 2023
            },
            {
                diploma: "DUT Génie Informatique - option : Génie Logiciel",
        ...
        experiences: [
            {
                type: "Stage",
                organisation: "Ministère de la Solidarité de la Femme de la Famille et du Développement Social",
                title: "Développement et maintenance de la plateforme digitale du programme d’encouragement à l’insertion professionnelle et aux projets générateurs de revenus pour les personnes en situation d’handicap.",
            ...
            {
                type: "Stage",
                organisation: "JDI Soft",
                title: "Conception et développement d'une application web de gestion de vente et de location du matériel informatique.",
                technologies: ["Spring Boot", "Angular"],
                year: 2022,
                duration: "2 mois"
            },
            {
                ...
                title: "Participation à la réalisation d'une application de gestion de la salle technique principale de l'entreprise.",
                technologies: ["JavaFX"],
                year: 2021,
                duration: "1 mois"
            },
            {
                type: "Projet",
                organisation: "EST-Fès",
                title: "Réalisation du portail académique du département Génie Informatique-ESTF.",
                technologies: ["Spring Boot", "Angular"],
                year: 2022,
                duration: "5 mois"
            }
        ...
        interests: ["Lecture : littérature française", "Sports : basketball"]
    },
    {
        profile: {
            photo: "resources/mehdi3.jpg",
            firstName: " El Mehdi",
    ...
    {
        profile: {
            photo: "resources/Masrour Ghita.png",
            firstName: "Ghita",
            lastName: "Masrour",
            birthday: {
                day: 10,
            ...
            professionalSummary: `Étudiante motivée en première année de master en Qualité du Logiciel (MQL), avec une spécialisation en développement web. Passionnée par le domaine du web, j'ai acquis une solide expérience dans les architectures logicielles et les technologies informatiques modernes telles que Jakarta EE, Spring Boot etc .  Je possède des compétences robustes en communication et en résolution de problèmes, et je suis reconnue pour ma capacité à collaborer efficacement avec les parties prenantes et les membres de l'équipe
        ...
        experiences: [
            {
                type: "Stage",
                organisation: "Hospitalier Universitaire de Fès (CHU)",
                title: "Stage au Centre Hospitalier Universitaire de Fès (CHU)",
                technologies: ["JEE ", "architecture 3 tiers"],
                year: 2023,
                duration: "1 mois"
            },
            {
                type: "Stage",
                organisation: "La commune de Fès",
                title: "Stage à la commune de Fès",
    ...
    {
        profile: {
            photo: "resources/Miftah_Asmaa.png",
            firstName: "Asmaa",
            lastName: "Miftah",
            birthday: {
                day: 24,
    ...
    {
        profile: {
            photo: "resources/Mikh_Houssam.jpg",
            firstName: "Houssam",
            lastName: "Mikh",
            birthday: {
                day: 5,
            ...
            phone: "+212 650 527276",
            email: "houssammikhe@gmail.com",
            address: "Fés",
            professionalSummary: `Étudiant en Master 1 Qualité Logiciel, je suis passionné par le développement
            et l'assurance qualité. Motivé et curieux, je cherche un stage pour appliquer mes connaissances et contribuer
            activement aux projets d'une équipe dynamique.`,
            links: ["https://www.github.com/houssam-mikh", "https://www.linkedin.com/mikh-houssam"]
        },
        education: [
            {
                diploma: "Master Qualité Logiciel MQL (en cours)",
                organisation: "FSDM - Université Sidi Mohammed ben Abdellah - Fès",
                year: 2023
            },
            {
                diploma: "Licences en sciences mathématiques et informatique",
                organisation: "FSDM - Université Sidi Mohammed ben Abdellah - Fès",
                year: 2022
            }, {
                diploma: "Deug en siences mathématiques et informatique",
                organisation: "FSDM - Université Sidi Mohammed ben Abdellah - Fès",
                year: 2021
            }
        ...
        experiences: [
            {
                type: "Projet",
                organisation: "FSDM",
                title: "Autogénérateur des diagrammes UML ",
                technologies: ["XML", "java", "swing"],
                year: 2023,
                duration: "4 mois"
            },
            {
                type: "Projet",
                organisation: "FSDM",
                title: "réalisation d'une application de gestion de restauration d'USMBA",
                technologies: ["HTML", "CSS", "JavaScript", "spring"],
                year: 2023,
                duration: "3 mois"
            }
        ],
        softSkills: ["Rapidité d'aprentissage", "Communication", "Esprit d'équipe", "Intelligence Emotionnelle", "Empatie et Ecoute", "Capacité de Résolution de problèmes", "Gestion du Temps", "Présence"
        ],
        languages: [
            {
                language: "Français",
        ...
        interests: ["Jouer au échecs", "Nataion", "Jeux video", 'Voyage'],
        certifications: [
            {
                title: "Data Structures & Backend with Java",
                organisation: "Coursera(Board Infinity)",
                link: "https://www.coursera.org/account/accomplishments/verify/S4ZPC7LVB683"
            },
            {
                title: "Programming with JavaScript",
                organisation: "Coursera(Meta)",
                link: "https://www.coursera.org/account/accomplishments/verify/UPJ3PG62AKKZ"
            },
            {
                title: "Getting started with git and github",
                organisation: "Coursera(IBM)",
                link: "https://www.coursera.org/account/accomplishments/verify/8ESHFJH7TEM9"
            },
            {
                title: "Introduction à la programmation orientée objet(en java)",
                organisation: "coursera( École Polytechnique Fédérale de Lausanne)",
                link: "https://www.coursera.org/account/accomplishments/verify/8C3V8QH5AFGD"
            }
        ]
    },
    {
        profile: {
            photo: "resources/Oubella FatimaEzzahrae.jpg",
    ...
    },
    {
        profile: {
            ...
            phone: "06 59 82 38 72",
            email: "Tajry.mohammed@gmail.com",
            address: "Meknes",
            professionalSummary: `Je suis un étudiant motivé en génie logiciel qui souhaite découvrir de nouvelles opportunités pour développer mes compétences et mettre en pratique mes connaissances en programmation. J'ai de solides aptitudes techniques en langages de programmation tels que Java, JavaScript et C. 
                J'ai également une bonne maîtrise des technologies Web telles que Java Enterprise Edition (JEE) et Node.js. 
                Je recherche un milieu de travail stimulant où je peux acquérir de nouvelles connaissances progresser et contribuer à des projets de développement de logiciels captivants.`,
            links: ["https://www.linkedin.com/"]
        },
        education: [
            {
                diploma: "Master Spécialisé Qualité du Logiciel (MQL)",
                organisation: "USMBA, Fès",
                year: "2023 - 2025"
            },
            {
                diploma: "Licence professionnelle en Réseaux, Sécurité et Systèmes Informatiques",
                organisation: "UCA, Marrakech",
                year: "2021 - 2022"
            },
            {
                diploma: "Licence professionnelle en Génie des Systèmes et Réseaux Informatiques",
                organisation: "Univh2c, Casablanca",
                year: "2020 - 2021"
            },
            {
                diploma: "Diplôme Technicien Spécialisé - Techniques des réseaux informatiques",
                organisation: "ISTAG, Meknes",
                year: "2018 - 2020"
            }
        ],
        technologySkills: [
            {
                ...
                details: ["Architecture 3 tiers", "MVC/MVC2", "Servlets", "JSP", "Apache Tomcat/TomEE"]
            },
            {
                skill: "Ingénierie DevOps",
                details: ["Git", "GitLab", "GitHub", "JUnit", "Jira", "ant", "Maven"]
            },
            {
                skill: "Ingénierie du Web",
                details: ["HTML", "CSS", "JavaScript", "TypeScript", "Ajax", "ReactJS", "JEE", "Node.JS", "PHP"]
            },
            {
                skill: "Technologie XML",
                details: ["Standard XML", "Bases de données XML", "Parseurs XML (DOM, SAX)", "DTD", "XSD (XML Schema)", "XSLT", "XPath", "XQuery"]
            ...
            {
                skill: "Bases de données",
                details: ["SQL", "SQL3", "PLSQL", "MySQL", "MS SQL Server", "Oracle Database"]
            },
            {
                skill: "Ingénierie des réseaux",
                details: [
                    "Routing & Switching (CCNA, CCNP)", "Network interconnection (Private WAN & Public WAN)",
                    "Firewalling: Cisco ASA, Netgate, Fortigate", "Virtualization (VCP-DCV)",
                    "Administration Sous Linux (RHEL)", "Administration sous windows server (MCSA)",
                    "Implementation VOIP (elastix)", "Sécurité des réseaux informatiques",
                    "Penetration Testing (White Box & Black Box)", "SOHO Network Configuration (netis, tp-link, dlink, sagem, ZTE)"
                ]
            }
        ],
        ...
        experiences: [
            {
                type: "Stage Libre",
                organisation: "Data Science - AutoFormation",
                title: "Machine Learning Project - House Price Regression",
                technologies: ["Python", "Matplotlib", "pandas", "Tensoflow", "Keras", "sklearn"],
                year: 2023,
                duration: "9 mois"
            },
            {
                type: "Stage",
                organisation: "La présidence de l'université Cadi Ayyad",
                title: "Digital Workplace et développement d'un site web e-learning",
                technologies: ["keycloak", "SpringBoot", "JavaScript", "HTML", "CSS", "OpenLdap"],
                year: 2022,
                duration: "2 mois",
            ...
            {
                type: "Stage",
                organisation: "Chambre de commerce d'industrie et de services",
                title: "la meilleure solution pour un réseau CAN",
                technologies: ["Vsphere esxi", "Cisco ASA", "Fortigate", "IPS System", "Cisco ISE", "Active Directory", "IPSec", "kiwi syslog server", "Nagios"],
                year: 2020,
                duration: "1 mois"
            },
            {
                type: "Stage",
                organisation: "stetson",
                title: "caméra de surveillance, Câblage, Implémentation des systèmes Réseaux informatiques",
                technologies: ["DVR", "NVR", "XVR"],
                year: 2019,
                duration: "2 mois",
            },
            {
                type: "Temps partiel",
                organisation: "Globale Bauarbeiten",
    ...
    {
        profile: {
            photo: "resources/Zaoui_Manar.jpeg",
            firstName: "Manar",
            lastName: "Zaoui",
            birthday: {
                day: "04",
    ...
    {
        profile: {
            photo: "resources/hamza_seddouki.jpeg",
            firstName: "Hamza",
            lastName: "SEDDOUKI",
            birthday: {
                day: 4,
